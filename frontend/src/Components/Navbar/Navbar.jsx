        ...
        <div className="flex items-center mr-4 space-x-4">
          {!isLogin && (
            <>
              <Link
                to="/login"
                className="bg-orange text-orange-600 px-4 py-2 rounded-full hover:bg-ornage-700 hover:bg-orange-100"
              >
                Log In
              </Link>
              <Link
          ...
          {isLogin && (
            <button
              className="bg-white text-orange-600 px-4 py-2 rounded-full hover:bg-orange-100"
            ...
            {isDropdownOpen && (
              <ul className="absolute top-16 left-0 right-0 bg-white shadow-md p-2 rounded-md">
                <li>
                  <Link
                    to="/"
                    className="text-gray-600 hover:text-ornage-500"
